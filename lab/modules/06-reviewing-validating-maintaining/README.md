...
See `../../../demo/modules/06-reviewing-validating-maintaining/README.md` for this
module's presenter/demo talk track ("the highest-leverage moment in the whole course")
— not needed to complete the hands-on above.
