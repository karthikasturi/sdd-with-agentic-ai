...
1. Open `delegation-transcript.md`'s "What came back" list, then run the real
   verification commands live (`go test`, `ng test`) — *"Not 'the agent said it works.'
   A number, from a real test run, that anyone reviewing this could reproduce
   themselves."*
